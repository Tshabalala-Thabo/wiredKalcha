        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add a Social Video</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="addvid.php?vtype=s" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success">Add Social Video</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="main-c">
            ...
            <div class="p-content">
                <div class="row justify-content-center">
                    <?php
                    $sql = "SELECT v_link, v_id FROM videos WHERE v_type = 's'";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '  <div class="colorr col-10 col-md-5 col-lg-5">
                                    ...
                                    <div class="v-actions">
                                    <a href="delvid.php?vid='.$v_id.'&vtype=s"><button class="btn btn-danger">Delete</button></a>
                                    </div>
                                </div>
                            ';
                    }
